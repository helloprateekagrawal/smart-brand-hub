        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center gap-8 flex-wrap">
            ...
            <Card className="border-0 shadow-lg w-72 text-center">
              <CardContent className="p-6">
                <img
                  src={advisorKamaljeet}
                  alt="Kamaljeet Rastogi"
                  className="w-32 h-32 rounded-full mx-auto mb-4 object-cover"
                />
                <h3 className="text-xl font-semibold text-card-foreground mb-2">Kamaljeet Rastogi</h3>
                <a
                  href="https://www.linkedin.com/in/kamaljitrastogi/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 text-primary hover:underline"
                >
